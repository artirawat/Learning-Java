...
class ABCDEF {
	...
	void takeInputFromAFile() throws IOException {
		...
		String path = "C:\\Users\\Ryzen 5\\git\\Learning-Java\\Learning Java\\src\\Unit_03\\input.txt";
...
//		}
	...
	void saveOutputIntoAFile() throws IOException {
		...
		try {
			myObj = new FileWriter("C:\\Users\\Ryzen 5\\git\\Learning-Java\\Learning Java\\src\\Unit_03\\output.txt");
		} catch (IOException e) {
	...
	void saveLogOfProgram() throws IOException {
		...
		try {
			myObj = new FileWriter("C:\\Users\\Ryzen 5\\git\\Learning-Java\\Learning Java\\src\\Unit_03\\log.txt", true);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
