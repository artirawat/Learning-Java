/*
 * As given there are two sample methods: First one returns the sum of two numbers a and b and
 * second one returns the subtraction of a and b. if a-b is negative then return value would be 0.
 * Use ternary operator to call these two methods.
